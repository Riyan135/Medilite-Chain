                ...
                <div className="flex items-start justify-between gap-4">
                  <div className="flex min-w-0 items-center gap-4">
                    ...
                    <div className="min-w-0">
                      <p className="truncate text-xl font-bold text-slate-900">{consultation.patient?.name || 'Unknown Patient'}</p>
                  ...
                  <span className={`shrink-0 rounded-full border px-2.5 py-1 text-[10px] font-bold uppercase tracking-widest ${statusStyles[consultation.status] || statusStyles.PENDING}`}>
...
const Stat = ({ title, value, icon: Icon, tone }) => {
  ...
  return (
    <div className="rounded-[2rem] border border-slate-100 bg-white p-6 shadow-sm">
      ...
      <p className="mt-5 text-[10px] font-bold uppercase tracking-widest text-slate-500 opacity-70">{title}</p>
      <p className="mt-1 text-5xl font-bold text-slate-900">{value}</p>
    </div>
  );
};
